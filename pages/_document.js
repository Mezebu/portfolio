    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta
            name="theme-color"
            content={themes.default.palette.primary.main}
          />
          <link rel="shortcut icon" href="/hlogo.svg" />
          <link
            rel="stylesheet"
          ...
          />
          <link
            href="https://fonts.googleapis.com/css2?family=Josefin+Slab:wght@100;200;300;400;500;600;700&display=swap"
            rel="stylesheet"
          ></link>
          <link
